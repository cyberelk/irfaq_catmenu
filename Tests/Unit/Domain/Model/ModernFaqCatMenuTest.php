...
/**
 * Test case for class Tx_IrfaqCatmenu_Domain_Model_ModernFaqCatMenu.
 *
 * @version $Id$
 ...
 */
class Tx_IrfaqCatmenu_Domain_Model_ModernFaqCatMenuTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
